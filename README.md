...
本プロジェクトでは、短期間での実装速度と今後の拡張性を重視して以下の技術を選定しています。
...
- Express 単体と比べて設計規約が強く、チーム開発や機能追加の際にも管理しやすい構成です。
...
- frontend / backend / db 各コンテナの環境再現が容易で、検証手順を統一できます。
