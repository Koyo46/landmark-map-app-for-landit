...
## 今後の改善点
- 縮尺を広げた時に、マーカーが何重にも重なって見えづらくなってしまっていたため、まとめて何個ぐらいマーカーがあるかや、マーカーのスタイルを縮尺によって変えるなどのように、改善したい
- 現状フロントに全スポットの情報を渡してから、マップの表示範囲や円でフィルタリングしているが、もしスポット数が数千、数万件とかになれば、範囲を絞ったうえでどれくらいスポットがあるかバックエンドに問い合わせる仕様が必要になるだろう。
